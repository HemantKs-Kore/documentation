// //fast.appcues.com/112004.js
window.AppcuesSettings = {
  enableURLDetection: true,
};

// downloaded appcues file
(function (self, ns) {
  var GENERIC_BUNDLE_URL =
    'https://fast.appcues.com/generic/main/4.41.2/appcues.main.27d10d7d111ac741f4af6e41925df343937a94be.js';
  var ACCOUNT_DETAILS = {
    GENERIC_BUNDLE_DOMAIN: 'https://fast.appcues.com',
    GENERIC_BUNDLE_PATH:
      '/generic/main/4.41.2/appcues.main.27d10d7d111ac741f4af6e41925df343937a94be.js',
    RELEASE_ID: '27d10d7d111ac741f4af6e41925df343937a94be',
    VERSION: '4.41.2',
    account: {
      buffer: 0,
      gates: {
      ...
      stripePlanId: 'plan_GgHFbvzwv07Lld',
    },
    accountId: '112004',
    custom_events: [
      {
        ...
        enabledBy: null,
        id: null,
        name: 'appcues_custom:Indices_trigger',
        state: 'ENABLED',
        targets: [
          {
            event: 'click',
            selector: {
              selector:
                '.headerTabsContainer [routerlinkactive="active"]:nth-of-type(3)',
            },
          },
        ],
        updatedAt: null,
      ...
      },
      {
        ...
        enabledBy: null,
        id: null,
        name: 'appcues_custom:Sources-Walkthrough',
        state: 'ENABLED',
        targets: [
          {
            event: 'click',
            selector: {
              selector:
                '.headerTabsContainer [routerlinkactive="active"]:nth-of-type(2)',
            },
          },
        ],
        updatedAt: null,
        updatedBy: null,
        urls: ['https://searchassist-qa.kore.ai/home/'],
      },
    ],
    integrations: {},
    styling: {
      ...
      id: 'e9e5f6ff-b9f7-4281-ab6f-fa0171f784ff',
      theme: {
  ...
  function load() {
    ...
    bundleScript.integrity =
      'sha256-E4ly3kQOjLH00HxjYCJ3oIeyrNduh5BYGCAl3UJH8AY=';
