...
export class EndPointsService {
  ...
  public init() {
    ...
    this.serviceList['get.presentableFields'] = {
      endpoint: this.API_SERVER_URL +'/findly/stream/:streamId/indexPipeline/:indexPipelineId/queryPipeline/:queryPipelineId/presentable?page=:pageno&limit=:limit&isSelected=:isSelected&orderBy=:orderType&sortyBy=:&isSearchable=:isSearchable&search=:searchKey',
      method: 'get'
    }
    ...
    this.serviceList['get.highlightFields'] = {
      endpoint: this.API_SERVER_URL +'/findly/stream/:streamId/indexPipeline/:indexPipelineId/queryPipeline/:queryPipelineId/highlights?page=:pageno&limit=:limit&isSelected=:isSelected&orderBy=:orderType&sortyBy=:sortField&search=:searchKey',
      method: 'get'
    }
    ...
    this.serviceList['get.spellcorrectFields'] = {
      endpoint: this.API_SERVER_URL +'/findly/stream/:streamId/indexPipeline/:indexPipelineId/queryPipeline/:queryPipelineId/spell-correct?page=:pageno&limit=:limit&isSelected=:isSelected&orderBy=:orderType&sortyBy=:sortField&search=:searchKey',
      method: 'get'
    }
