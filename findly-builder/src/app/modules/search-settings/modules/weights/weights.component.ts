...
export class WeightsComponent implements OnInit, OnDestroy {
  ...
  restore(dialogRef?) {
    ...
    this.service.invoke('post.restoreWeights', quaryparms).subscribe(
      (res) => {
  ...
  restoreWeights(event) {
    ...
    const dialogRef = this.dialog.open(ConfirmationDialogComponent, {
      ...
      data: {
        ...
        newTitle:
          'Resetting to default will reset the values of System defined fields to default values.',
