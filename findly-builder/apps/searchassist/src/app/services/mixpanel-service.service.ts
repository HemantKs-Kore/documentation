...
export class MixpanelServiceService {
  ...
  PLGScoresevents = {
    ...
    'Joined Workspace': 3,
    'Start create app': 5,
    'Content Crawl web domain added': 2,
    'Content Crawl web domain success': 3,
    'Content File extraction started': 2,
    'Content File extraction success': 4,
    'FAQ Web extract added': 2,
    'FAQ Web extract success': 4,
    'FAQ File extraction started': 2,
    'FAQ File extraction success': 4,
    'Manual FAQ added': 4,
    //"Enter Fields": 1,
    'Add Field complete': 5,
    'Trait Group created': 3,
    'Trait utterance added': 4,
    //"Enter Workbench":1,
    'Workbench Stage added': 5,
    'Workbench Simulated': 3,
    'Workbench simulation failed': 3,
    'Workbench simulation complete': 5,
    //"Enter Weights":0,
    'Save Weights': 5,
    'Plan Chosen': 2,
    'Plan Standard Proceed': 2,
    'Plan Purchased': 5,
    'Topic - Play Topic Video': 3,
    'Topic - FAQ Accessed': 3,
    'Topic - Documentation visited': 3,
  };
  excludedMailDomains = [
    'mailinator.com',
    'yopmail.com',
  ...
  oneTimeProperties = (payload, userInfo) => {
    ...
    try {
      if (
        mixpanel &&
        userInfo.email &&
        window.appConfig.USAGE_ANALYTICS &&
        window.appConfig.USAGE_ANALYTICS.ENABLE &&
        window.appConfig.USAGE_ANALYTICS.MIX_PANEL &&
        window.appConfig.USAGE_ANALYTICS.MIX_PANEL.ENABLE &&
        window.appConfig.USAGE_ANALYTICS.MIX_PANEL.MIX_PANEL_TOKEN
      ) {
